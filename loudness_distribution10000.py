...
def func_to_extract_loudness(filename):
    """
...
print 'number of song files:',apply_to_all_files(msd_subset_data_path, func=func_to_extract_loudness)
print 'Number of songs which dont have loudness is:', cntnan
