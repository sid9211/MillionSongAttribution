...
print 'number of song files:',apply_to_all_files(msd_subset_data_path, func=func_to_extract_hotness)
print 'Number of songs which dont have hotness is:', cntnan
plt.hist(listhotness)
plt.xlabel('Hotness range')
plt.ylabel('Number of songs')
plt.title('Hotness Histogram')
plt.grid(True)
plt.show()
